...
function SystemStats({
  ...
  return (
    <div className="absolute top-4 right-4 z-20">
      <div
        className="bg-slate-900/90 backdrop-blur-sm border-2 border-cyan-500/50 rounded-lg p-4 min-w-[280px]"
      ...
      >
        ...
        <div className="space-y-2 mb-3 text-cyan-300">
          ...
          <StatusIndicator active={faceDetected} label="FACE TRACKING" />
          <StatusIndicator
        ...
        <div className="text-cyan-300">
          <div className="text-xs font-mono mb-2 text-cyan-400">
            SYSTEM STATS
          </div>
