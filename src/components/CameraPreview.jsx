...
function CameraPreview({ isActive, onToggle }) {
  ...
  return (
    <div className="absolute bottom-4 right-4 z-20">
      <div className="bg-slate-900/90 backdrop-blur-sm border-2 border-cyan-500/50 rounded-lg overflow-hidden"
        ...
        <div className="bg-slate-800/80 px-3 py-2 border-b border-cyan-500/50 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-mono text-cyan-300 font-bold">VISUAL FEED</span>
          </div>
          <button
            onClick={onToggle}
