      ...
      <div className="relative z-10 text-center">
        ...
        <div className="mb-12">
          <div className="relative">
            <h1 className="text-8xl font-bold text-cyan-400 tracking-wider mb-4" 
                style={{
                  textShadow: '0 0 10px rgba(34, 211, 238, 0.8), 0 0 20px rgba(34, 211, 238, 0.6), 0 0 40px rgba(34, 211, 238, 0.4), 0 0 80px rgba(34, 211, 238, 0.2)'
                }}>
              A.V.A
            </h1>
            {/* Glitch overlay */}
            <div className="absolute inset-0 text-8xl font-bold text-cyan-300 opacity-50 animate-pulse"
        ...
        >
          ...
          {/* Button text */}
          <span className="relative z-10 tracking-wider">INICIALIZAR SISTEMA</span>
